...
func (r *PiRPCResponder) Respond(ctx context.Context, prompt string, maxOutput int) (Response, error) {
	...
	for {
		...
		if err != nil {
			...
			return Response{Metrics: startupMetrics, ToolCompleted: toolCompleted, SideEffectToolCompleted: sideEffectCompleted, MessagingSideEffectToolCompleted: messagingSideEffectCompleted, ThreadReplyToolCompleted: threadReplyCompleted}, &ResponderTurnError{Cause: cause, ToolCompleted: toolCompleted, SideEffectToolCompleted: sideEffectCompleted}
		}
		switch record.Type {
		case "response":
			if record.ID == id {
		...
		case "agent_settled":
			...
			return Response{Reply: reply, ToolCompleted: toolCompleted, SideEffectToolCompleted: sideEffectCompleted, MessagingSideEffectToolCompleted: messagingSideEffectCompleted, ThreadReplyToolCompleted: threadReplyCompleted, Metrics: startupMetrics}, nil
		}
	}
}
